        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valid) {
                    ...
                    dbManager.close();
                    Intent login = new Intent(getApplicationContext(), Activity_Member_Menu.class);
                    startActivity(login);
                }
                else
                {
                    Toast.makeText(getApplicationContext(), "Sign Up Error: Please try again.", Toast.LENGTH_SHORT).show();
                }
