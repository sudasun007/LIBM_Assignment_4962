...
public class Activity_Publisher_M extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if(valid) {
                    ...
                    dbManager.insert("insert into Publisher values('" + Name + "','" + Address + "'," +
                            "'" + Phone + "')");
                    Toast.makeText(Activity_Publisher_M.this, "Entry successful.", Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(Activity_Publisher_M.this, "Error encountered while adding Publisher.", Toast.LENGTH_SHORT).show();
                }
        ...
        clearpub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getApplicationContext(),
                        "You have successfully deleted the Publisher.", Toast.LENGTH_SHORT).show();
            }
        });
    }
